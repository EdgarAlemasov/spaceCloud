...
class FileAgentAdmin(admin.ModelAdmin):
    ...
    search_fields = ("file_name", "create_by__user_name")
...
class FileShareAdmin(admin.ModelAdmin):
    ...
    search_fields = ("user_file__create_by__user_name", "user_file__file_name")
...
class UserMessageAdmin(admin.ModelAdmin):
    ...
    search_fields = ("create_by__user_name",)
    readonly_fields = ("create_by", "create_time", "update_by", "update_time")
    list_select_related = ("create_by",)
...
class UserLogAdmin(admin.ModelAdmin):
    ...
    list_display = ("user_name", "ip_address", "browser", "os", "action", "action_time")
    list_filter = ("action",)
    list_per_page = 15
